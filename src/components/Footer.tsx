...
const websiteTeam = [
  { 
    role: "Web Developer", 
    members: [
      { name: "Aufan Taufiqurrahman", instagram: "https://www.instagram.com/aufant_/" }
    ] 
  },
  { 
    role: "UI/UX Design", 
    members: [
      { name: "Regi Heksa Ananda", instagram: "https://www.instagram.com/aufant_/" },
      { name: "Jardel Poliviera", instagram: "https://www.instagram.com/aufant_/" }
    ] 
  }
];
...
const XIcon = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg>
);

const TikTokIcon = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.89-.6-4.13-1.47-.76-.52-1.45-1.19-1.98-1.97-.05 1.78.01 3.56-.01 5.34 0 .91-.07 1.84-.28 2.73-.52 2.37-2.31 4.58-4.66 5.25-2.26.65-4.9-.11-6.43-1.89-1.85-2.07-1.92-5.49-.16-7.65 1.53-1.97 4.26-2.73 6.64-1.91v4.21c-1.28-.43-2.82-.19-3.82.74-.82.74-1.04 1.99-.54 2.97.47.93 1.58 1.48 2.61 1.34 1.02-.12 1.93-.97 2.1-1.98.08-.43.08-.88.08-1.32V.02Z"/></svg>
);

const YoutubeIcon = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.42a2.78 2.78 0 0 0-1.94 2C1 8.14 1 12 1 12s0 3.86.42 5.58a2.78 2.78 0 0 0 1.94 2c1.71.42 8.6.42 8.6.42s6.88 0 8.6-.42a2.78 2.78 0 0 0 1.94-2C23 15.86 23 12 23 12s0-3.86-.42-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02"/></svg>
);

const socialLinks = [
  { icon: InstagramIcon, href: "https://www.instagram.com/festika.ua/", label: "Instagram" },
...
const contacts = [
  { phone: "+62-823-1148-8810", name: "Fadhil" }
];
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col">
            ...
            >
              Fakultas Teknologi Informasi, Universitas Andalas, Kampus Limau Manis, Kota Padang, Sumatera Barat, Indonesia.
            </a>
          </div>
            ...
            <ul className="space-y-6">
              {websiteTeam.map((section) => (
                <li key={section.role} className="flex flex-col space-y-2">
                  <span className="text-white font-bold text-[15px]">{section.role}</span>
            ...
            <div className="flex flex-col space-y-3">
              {contacts.map((contact, index) => (
                <a 
                  ...
                  className="text-[#8F8D98] hover:text-white transition-all text-[15px] hover:underline underline-offset-4"
                >
                  {contact.phone} <span className="ml-1">( {contact.name} )</span>
                </a>
              ))}
            </div>
          </div>
